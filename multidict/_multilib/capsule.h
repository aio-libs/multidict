...
typedef struct _multidict_capi {
    // md_get_all
    int (*_MultiDict_GetAll)(MultiDictObject *self, PyObject *key,
                             PyObject **ret);
    // md_get_one
    int (*_MultiDict_GetOne)(MultiDictObject *self, PyObject *key,
                             PyObject **ret);
    ...
    // md_add
    int (*_MultiDict_Add)(MultiDictObject *self, PyObject *key,
                          PyObject *value);
    ...
    // multidict_extend
    PyObject *(*_MultiDict_Extend)(MultiDictObject *self, PyObject *args,
                                   PyObject *kwargs);
    ...
    PyObject *(*_MultiDict_SetDefault)(MultiDictObject *self, PyObject *key,
                                       PyObject *value);

    // md_pop_one
    int (*_MultiDict_PopOne)(MultiDictObject *self, PyObject *key,
                             PyObject **ret);

    // md_pop_all
    int (*_MultiDict_PopAll)(MultiDictObject *self, PyObject *key,
                             PyObject **ret);
    ...
    // multidict_update
    PyObject *(*_MultiDict_Update)(MultiDictObject *self, PyObject *args,
                                   PyObject *kwds);
