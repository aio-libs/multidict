...
def sanitize_rst_roles(rst_source_text: str) -> str:
    ...
    issue_substitution_pattern = (
        r"`#\g<issue_number> "
        r"<https://github.com/aio-libs/multidict/issues/\g<issue_number>>`__"
    )
    ...
    pr_substitution_pattern = (
        r"`PR #\g<pr_number> "
        r"<https://github.com/aio-libs/multidict/pull/\g<pr_number>>`__"
    )
    ...
    commit_substitution_pattern = (
        r"`\g<commit_sha> "
        r"<https://github.com/aio-libs/multidict/commit/\g<commit_sha>>`__"
    )
