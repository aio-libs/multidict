...
def test_multidict_insert_str(
    benchmark: BenchmarkFixture, any_md_class: Type[MultiDict[str]]
) -> None:
    md = any_md_class()
...
def test_cimultidict_insert_istr(
    ...
    ci_md_class: Type[CIMultiDict[istr]],
) -> None:
    md = ci_md_class()
...
def test_multidict_pop_str(
    ...
    md_base = any_md_class((str(i), str(i)) for i in range(200))
...
def test_cimultidict_pop_istr(
    ...
    md_base = ci_md_class((istr(i), istr(i)) for i in range(200))
...
def test_multidict_popitem_str(
    ...
    md_base = any_md_class((str(i), str(i)) for i in range(100))
...
def test_multidict_clear_str(
    ...
    md = any_md_class((str(i), str(i)) for i in range(100))
...
def test_multidict_update_str(
    ...
    md = any_md_class((str(i), str(i)) for i in range(150))
...
def test_cimultidict_update_istr(
    ...
    md = ci_md_class((istr(i), istr(i)) for i in range(150))
...
def test_multidict_extend_str(
    ...
    base_md = any_md_class((str(i), str(i)) for i in range(100))
...
def test_cimultidict_extend_istr(
    ...
    base_md = ci_md_class((istr(i), istr(i)) for i in range(100))
...
def test_cimultidict_delitem_istr(
    ...
    md_base = ci_md_class((istr(i), istr(i)) for i in range(100))
    items = [istr(i) for i in range(100)]
...
def test_cimultidict_fetch_istr(
    ...
    md = ci_md_class((istr(i), istr(i)) for i in range(100))
    items = [istr(i) for i in range(100)]
...
def test_multidict_repr(
    ...
    items = [str(i) for i in range(100)]
    md = any_md_class([(i, i) for i in items])
...
def test_create_from_existing_cimultidict(
    ...
    existing = ci_md_class((istr(i), istr(i)) for i in range(5))

    @benchmark
    def _run() -> None:
        ci_md_class(existing)
